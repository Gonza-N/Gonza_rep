...
\begin{parts}
  ...
  \part[4]{Determine la distancia $l$ con tal de adaptar la parte real de la impedancia equivalente y $l_s$ con tal de adaptar la parte imaginaria de la linea de transmisión tanto en corto circuito ($l_{s}^{cc}$) como en circuito abierto ($l_{s}^{ca}$).}
